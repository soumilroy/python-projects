...
birth_date = "24/11/1930"
print(birth_date.split('/'))  # ['24', '11', '1930']
print(birth_date.split(' '))  # returns entire string in list ['24/11/1930']

my_name1 = "S--O--U--M--I--L"
my_name2 = "S-*-O-*-U-*-M-*-I-*-L"
# ['S', '', 'O', '', 'U', '', 'M', '', 'I', '', 'L']
